...
mbox\cite{Hall2005}, un formato estandarizado que utilizan la mayoria 
de los sistemas de gestión de listas de correo, entre otros:
...
\begin{itemize}
  ...
  \item \textbf{Identificadores:} cada correo dispone de un identificador 
	...
	Este es el mecanismo especificado en el RFC\cite{Resnick2001} para 
