...
\title{%
	SWAML, Publicación de listas de correo en Web Semántica}
...
\begin{tabular}{|l|l|l|}
 ...
 Ago/2006 & 0.0.2 & Segundo borrador \\\hline
 Oct/2006 & 0.0.3 & Tercer borrador con el índice definitivo \\\hline
\end{tabular}
...
%  2. Planificación
%  3. Metodología (¿proceso unificado?)
%	- Análisis
%	- Diseño
%	- Pruebas
%  4. Conclusiones
%  Anexo A: Propuesta inicial de Diego
%  Anexo B: Manuales
%  Anexo C: Ontología
...
\input{web-semantica.tex}

\input{analisis.tex}

\input{diseno.tex}

\input{entorno-tecnologico.tex}
