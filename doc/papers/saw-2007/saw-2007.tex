...
\institute{Fundaci\'on CTIC and Universidad de Oviedo, \\
Asturias, Spain,\\
\email{sergio.fernandez@fundacionctic.org, diego.berrueta@fundacionctic.org, labra@uniovi.es},\\
WWW home page: \texttt{http://swaml.berlios.de/}
}

%FIXME: add institutes, something like:
%\author{
...
%}
%
%\institute{R&D Department, Fundaci\'on CTIC, Gij\'on, Asturias, Spain
%\and Technical School of Computer Science, Universidad de Oviedo, Oviedo, Asturias, Spain}
...
paper is organized as follows: \textbf{FIXME}.
