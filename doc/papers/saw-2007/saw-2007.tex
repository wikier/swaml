...
>
  <sioc:Post rdf:about="http://swaml.berlios.de/demo/2006-Oct/post-50.rdf">
    <dc:title>SIOC properties cardinality</dc:title>
    <sioc:id>ee5f9a4c016208bc64daed456bd7c0696d760909</sioc:id>
    <sioc:has_creator rdf:resource="http://swaml.berlios.de/demo/subscribers.rdf#s4"/>
    <dcterms:created>Thu, 12 Oct 2006 23:59:26 +0200</dcterms:created>
    <sioc:content>...</sioc:content>
    <sioc:has_reply rdf:resource="http://swaml.berlios.de/demo/2006-Oct/post-51.rdf"/>
    <swaml:previousByDate rdf:resource="http://swaml.berlios.de/demo/2006-Oct/post-49.rdf"/>
    <swaml:nextByDate rdf:resource="http://swaml.berlios.de/demo/2006-Oct/post-51.rdf"/>
  </sioc:Post>
</rdf:RDF
\end{lstlisting}
...
\end{lstlisting}
\caption{SPARQL query example to extract all the posts sent in a SIOC Forum instance}
