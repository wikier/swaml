...
on a generic `Forum' concept. Each forum represents an online community
...
`User' and `Post', which model respectively the members of the
...
purpose. However, additional object properties are required
