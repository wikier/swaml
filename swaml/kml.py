...
class SwamlKmlExporter:
    ...
    def process(self, input, output=None):
        ...
        if (n > 0):
            ...
            print 'Nobody with geographic information available in', path
        

    def usage(self):
        """
        Print help to use SWAML KML
        """
        
        print """
Usage: kml.py subscribers-rdf-file
        
export geographic information about SWAML's subscribers, described in RDF, into KML
